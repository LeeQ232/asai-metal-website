    ...
    <section id="catalog" className="bg-gradient-to-br from-black via-gray-900 to-purple-900 py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <span className="inline-block px-6 py-2 bg-red-500/20 text-red-400 font-bold text-sm uppercase tracking-wider rounded-full border border-red-500/30" style={{fontFamily: 'Montserrat, Roboto, Helvetica Neue, Arial, sans-serif'}}>
            BLUEPRINT OTOMASI PABRIK ANDA
          </span>
        </div>

        {/* Main Title */}
        <h3 className="text-4xl md:text-6xl font-bold text-center mb-16 text-white" style={{fontFamily: 'Montserrat, Roboto, Helvetica Neue, Arial, sans-serif', fontSize: '48px', fontWeight: '800', lineHeight: '1.1'}}>
          Solusi Otomasi Kami
        </h3>
        ...
        <div className="text-center mt-20">
          <div className="mb-6">
            <p className="text-gray-300 text-lg leading-relaxed max-w-4xl mx-auto" style={{fontFamily: 'Montserrat, Roboto, Helvetica Neue, Arial, sans-serif'}}>
          ...
          <div className="mb-8">
            <Link
              href="/stock"
              className="inline-flex items-center px-6 py-3 bg-gray-800/50 hover:bg-gray-700/50 text-gray-300 hover:text-white rounded-lg transition-all duration-300 border border-gray-600 hover:border-gray-500"
